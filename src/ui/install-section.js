...
const ICONS = {
  ...
  // Coffee cup (stroked, muted-tinted via the --support tile) for the
  // Buy-Me-a-Coffee support link — deliberately lower-key than the red
  // platform marks so it reads as a soft ask, not another install CTA.
  support: `<svg class="install-section__btn-icon" viewBox="0 0 24 24" aria-hidden="true">
    <path d="M4 8h12v5.5A4.5 4.5 0 0 1 11.5 18H8.5A4.5 4.5 0 0 1 4 13.5V8Z" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linejoin="round"/>
    <path d="M16 9.5h2.25a2.25 2.25 0 0 1 0 4.5H16" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M7.5 2.5v2.2M10 2.5v2.2M12.5 2.5v2.2" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/>
  </svg>`,
};
...
function supportTile() {
  return `<a class="install-section__btn install-section__btn--support" href="${SUPPORT_URL}" target="_blank" rel="noopener" data-support>
    ...
    <span class="install-section__btn-text">
      ...
      <span class="install-section__btn-sub">Buy me a coffee</span>
    </span>
    <svg class="install-section__btn-dl-icon" viewBox="0 0 24 24" aria-hidden="true" width="14" height="14">
